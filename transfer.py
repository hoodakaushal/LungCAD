...
class MainWindow(QMainWindow, ui_mainWindow.Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.connect(self.passwordLineEdit, SIGNAL('returnPressed()'), self.login)
    ...
    def login(self):
        ...
        self.userPassword = str(self.passwordLineEdit.text())
        try:
            self.ssh = paramiko.SSHClient()
            self.ssh.set_missing_host_key_policy(paramiko.AutoAddPolicy())
            print(self.hostAddress, self.userName, self.userPassword)
    ...
    def generateResults(self):
        ...
        stdin, stdout, stderr = self.ssh.exec_command(
            'sudo -u root /home/ec2-user/bin/genResults.sh ' + "'" + self.uploadedFileName + "'")
